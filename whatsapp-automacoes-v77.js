(function(){
  ...
  async function startEmbedded(){
    ...
    FB.login(resp=>{if(resp?.authResponse?.code){embeddedData.code=resp.authResponse.code;tryFinalize()}},{config_id:String(data.config_id),auth_type:'rerequest',response_type:'code',override_default_response_type:true,extras:{}});
  }
